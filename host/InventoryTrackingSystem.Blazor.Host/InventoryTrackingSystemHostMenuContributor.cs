...
public class InventoryTrackingSystemHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public InventoryTrackingSystemHostMenuContributor(IConfiguration configuration)
    {
