...
public class InventoryTrackingSystemWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public InventoryTrackingSystemWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<InventoryTrackingSystemResource>();
