        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumberPrefix = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnavailabilityReasons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProduct = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    AvailableProduct = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_SerialNumbers_SerialNumberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovementRequests_Sites+_FromSiteId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovementRequests_Sites+_ToSiteId",
                        column: x => x.ToSiteId,
                        principalSchema: "inventory",
                        principalTable: "Sites+",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSiteId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsAvailableForRequest = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    UnavailabilityReasonId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_SerialNumbers_SerialNumberId",
                        column: x => x.SerialNumberId,
                        principalSchema: "inventory",
                        principalTable: "SerialNumbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inventories_Sites+_CurrentSiteId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Inventories_UnavailabilityReasons_UnavailabilityReasonId",
                        column: x => x.UnavailabilityReasonId,
                        principalSchema: "inventory",
                        principalTable: "UnavailabilityReasons",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedSerialNumberId = table.Column<Guid>(type: "uuid", nullable: false),
                    RequestedQuantity = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovementRequestDetails", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovementRequestDetails_SerialNumbers_RequestedSerialNumberId",
                        column: x => x.RequestedSerialNumberId,
                        principalSchema: "inventory",
                        principalTable: "SerialNumbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovementRequestResponses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovementRequestResponses_MovementRequests_MovementRequestId",
                        column: x => x.MovementRequestId,
                        principalSchema: "inventory",
                        principalTable: "MovementRequests",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovementRequestDetailId = table.Column<Guid>(type: "uuid", nullable: false),
                    MovementStatus = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "DEPARTED"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryMovements_MovementRequestDetails_MovementRequestDe~",
                        column: x => x.MovementRequestDetailId,
                        principalSchema: "inventory",
                        principalTable: "MovementRequestDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryMovements_MovementRequests_MovementRequestId",
                        column: x => x.MovementRequestId,
                        principalSchema: "inventory",
                        principalTable: "MovementRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryMovements_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryHistories_InventoryMovements_MovementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_CurrentSiteId",
                schema: "inventory",
                table: "Inventories",
                column: "CurrentSiteId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_IsAvailableForRequest",
                schema: "inventory",
                table: "Inventories",
                column: "IsAvailableForRequest");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_SerialNumberId",
                schema: "inventory",
                table: "Inventories",
                column: "SerialNumberId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_UnavailabilityReasonId",
                schema: "inventory",
                table: "Inventories",
                column: "UnavailabilityReasonId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistories_EventType",
                schema: "inventory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistories_MovementId",
                schema: "inventory",
                table: "InventoryHistories",
                column: "MovementId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_IsCompleted",
                schema: "inventory",
                table: "InventoryMovements",
                column: "IsCompleted");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_MovementRequestDetailId",
                schema: "inventory",
                table: "InventoryMovements",
                column: "MovementRequestDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_MovementRequestId",
                schema: "inventory",
                table: "InventoryMovements",
                column: "MovementRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_MovementStatus",
                schema: "inventory",
                table: "InventoryMovements",
                column: "MovementStatus");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_VehicleId",
                schema: "inventory",
                table: "InventoryMovements",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovementRequestDetails_RequestedSerialNumberId",
                schema: "inventory",
                table: "MovementRequestDetails",
                column: "RequestedSerialNumberId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementRequestResponses_ApproverUserId",
                schema: "inventory",
                table: "MovementRequestResponses",
                column: "ApproverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementRequestResponses_MovementRequestId",
                schema: "inventory",
                table: "MovementRequestResponses",
                column: "MovementRequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovementRequests_FromSiteId",
                schema: "inventory",
                table: "MovementRequests",
                column: "FromSiteId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementRequests_RequesterUserId",
                schema: "inventory",
                table: "MovementRequests",
                column: "RequesterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MovementRequests_Status",
                schema: "inventory",
                table: "MovementRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_MovementRequests_ToSiteId",
                schema: "inventory",
                table: "MovementRequests",
                column: "ToSiteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_Name",
                schema: "inventory",
                table: "SerialNumbers",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_SerialNumberPrefix",
                schema: "inventory",
                table: "SerialNumbers",
                column: "SerialNumberPrefix",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnavailabilityReasons_Reason",
                schema: "inventory",
                table: "UnavailabilityReasons",
                column: "Reason",
                unique: true);
